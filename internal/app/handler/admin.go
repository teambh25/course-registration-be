...
func (h *AdminHandler) StartRegistration(c *gin.Context) {
	if err := h.adminService.StartRegistration(); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": "서버 오류"})
		return
	}
...
func (h *AdminHandler) SetRegistrationPeriod(c *gin.Context) {
	...
	// 	c.JSON(http.StatusBadRequest, gin.H{"message": "잘못된 수강 신청 기간"})
	// 	return
	// }
...
func (h *AdminHandler) RegisterStudents(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&students); err != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{"message": "잘못된 학생 리스트"})
		return
	}

	if err := h.adminService.RegisterStudents(students); err != nil {
		// todo: 중복된 학생 처리
		c.JSON(http.StatusBadRequest, gin.H{"message": "학생 리스트 등록 실패"})
		return
	}
...
func (h *AdminHandler) ResetStudents(c *gin.Context) {
	if err := h.adminService.ResetStudents(); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": "학생 리스트 삭제 실패, 개발자 호출 필요!"})
		return
	}
...
func (h *AdminHandler) CreateCourse(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(course); err != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{"message": "잘못된 강의 형식"})
		return
	}
	...
	if err != nil {
		// todo: 중복된 강의 처리
		c.JSON(http.StatusBadRequest, gin.H{"message": "강의 등록 실패"})
		return
	}
...
func (h *AdminHandler) DeleteCourse(c *gin.Context) {
	...
	if err := h.adminService.DeleteCourse(uint(course_id)); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"message": "강의 삭제 실패"})
	}
...
func (h *AdminHandler) RegisterCourses(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&courses); err != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{"message": "잘못된 강의 리스트"})
		return
	}

	if err := h.adminService.RegisterCourses(courses); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"message": "강의 리스트 등록 실패"})
		return
	}
...
func (h *AdminHandler) ResetCourses(c *gin.Context) {
	if err := h.adminService.ResetCourses(); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": "강의 리스트 삭제 실패, 개발자 호출 필요!"})
		return
	}
...
func (h *AdminHandler) ResetEnrollments(c *gin.Context) {
	if err := h.adminService.ResetEnrollments(); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": "수강 신청 초기화 실패, 개발자 호출 필요!"})
		return
	}
